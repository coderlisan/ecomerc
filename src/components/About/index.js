                    ...
                    <div className="row no-gutters">
                            ...
                            <div className="limupa-counter white-smoke-bg">
                                <div className="container">
                                    <div className="counter-img">
                                        <img src="images/about-us/icon/1.png" alt="about" />
                                    </div>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="limupa-counter gray-bg">
                                <div className="counter-img">
                                    <img src="images/about-us/icon/2.png" alt="about" />
                                </div>
                                <div className="counter-info">
                                    <div className="counter-number">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="limupa-counter white-smoke-bg">
                                <div className="counter-img">
                                    <img src="images/about-us/icon/3.png" alt="about" />
                                </div>
                                <div className="counter-info">
                                    <div className="counter-number">
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="limupa-counter gray-bg">
                                <div className="counter-img">
                                    <img src="images/about-us/icon/4.png" alt="about" />
                                </div>
                                <div className="counter-info">
                                    <div className="counter-number">
                                        <h3 className="counter">2169</h3>
